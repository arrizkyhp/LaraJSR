...
! function (t, e, a, i) {
    ...
    var r = {
        ...
        combineProducts: !0,
        highlightEffect: !0,
        cartItemTemplate: '<img class="img-responsive pull-left" src="{product_image}" /><h4 class="list-group-item-heading">{product_name}</h4><h4 class="list-group-item-heading">{product_jenis}</h4><p class="list-group-item-text">{product_desc}</p>',
        cartItemQtyTemplate: '{display_price} x {display_quantity} = {display_amount} ',
        productContainerSelector: ".sc-product-item",
        productElementSelector: "*",
        addCartSelector: ".sc-add-to-cart",
        paramSettings: {
            productPrice: "product_price",
            productQuantity: "product_quantitys",
            productName: "product_name",
            productId: "product_id"
        },
        lang: {
            cartTitle: "Daftar Pesanan",
            checkout: "Bayar",
            clear: "Clear",
            subtotal: "Subtotal:",
            cartRemove: "x",
            cartEmpty: "Daftar Pesanan Kosong!<br />Silahkan Pilih Menu"
        },
        submitSettings: {
            submitType: "form",
            ajaxURL: "",
    ...
    t.extend(s.prototype, {
        ...
        _addUpdateCartItem: function (e) {
            ...
            if (s && s.length > 0) s.find(".sc-cart-item-qty").val(e[this.options.paramSettings.productQuantity]), s.find(".sc-cart-item-amount").text(this._getMoneyFormatted(a));
                ...
                r += ' x <input type="number" min="1" max="1000" class="sc-cart-item-qty" value="' + this._getValueOrEmpty(e[this.options.paramSettings.productQuantity]) + '" />', r += ' = <span class="sc-cart-item-amount">' + this._getMoneyFormatted(a) + "</span></div>", s.append(r), i.append(s)
            }
